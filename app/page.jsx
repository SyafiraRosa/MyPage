        ...
        <div className="flex flex-col xl:flex-row items-center justify-between xl:pt-8 xl:pb-24">
          ...
          <div className="text-center xl:text-left order-2 xl:order-none">
            ...
            <h1 className="h1 mb-6">
              Hello I'm <br/><span className="text-accent">Syafira Rosa Amalia</span>
            </h1>
            <p className="max-w-[600px] mb-9 text-white/80">
              I’m passionate about building innovative digital solutions, specializing in Game Development, Human Computer Interaction, and Artificial Intelligence with various programming skills.
            </p>
            {/* btn and socials */}
