...
const projects = [
    ...
    },
    {
        ...
        category: "Game Development",
        title: "Jumping Boba",
        description: "The first game I created to fulfill task from DNCC UDINUS using Construct 2, where the goal is to collect as many coins or diamonds as possible without falling off the platform. It features 3 maps with different seasonal themes.",
